            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, index) => (
                        <div key={index} className="text-center py-8 px-4 border cursor-pointer border-pink-500/30 hover:border-pink-500 transition-colors rounded-lg shadow-lg bg-white bg-opacity-10 backdrop-blur-md flex flex-col justify-between">
