const ProcessSection = () => {
    return (
        <section className="py-8 md:py-16 lg:py-20 flex flex-col items-center justify-center bg-[#292929]">
            <h2 className="text-center text-2xl lg:text-5xl font-bold uppercase mb-6 md:mb-10 text-pink-500">The Process</h2>
            ...
            <div className="w-full flex flex-col md:flex-row items-center md:items-start justify-center gap-6 md:gap-8 mt-8 px-4 md:px-8">
                {/* Plan A */}
                <div className="text-white w-full md:w-[45vw] lg:w-[40vw] h-auto rounded-md bg-pink-500 text-black p-4 md:p-6 lg:p-8">
                    <div className="w-full mb-4">
                        <h3 className="text-white font-bold text-xl md:text-2xl lg:text-3xl text-black text-center">Plan A - Assured Returns</h3>
                    </div>
                ...
                <div className="text-white w-full md:w-[45vw] lg:w-[40vw] h-auto rounded-md bg-pink-500 text-black p-4 md:p-6 lg:p-8">
                    <div className="w-full mb-4">
                        <h3 className="text-white font-bold text-xl md:text-2xl lg:text-3xl text-black text-center">Plan B - Investment Returns</h3>
                    </div>
                    <div className="w-full">
                        <ul className="list-disc space-y-4 md:space-y-6 text-base md:text-lg lg:text-xl ml-4 md:ml-6">
